      ...
      <div className="finisher-header relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mt-[-4vh] w-full max-w-3xl px-6 text-center text-white">
          ...
          <h1 className="text-5xl md:text-7xl font-semibold tracking-tighter text-white/95">
            ...
            become{" "}
            <span className="font-light italic text-white/80">products</span>.
          </h1>
          ...
          <p className="mt-6 md:mt-8 text-base md:text-lg text-white/50 font-light tracking-wide max-w-lg mx-auto">
            Describe what you envision, and we will generate it instantly. No
            complexity, just creation.
          </p>
          ...
          <div className="mt-12 mx-auto max-w-xl">
            <form
              ...
              className="group relative flex flex-col items-center rounded-2xl bg-black/10 border border-white/10 backdrop-blur-md transition-all duration-300 focus-within:border-white/25 focus-within:bg-black/20 hover:border-white/20"
            >
              <input
                value={prompt}
              ...
              <div className="w-full flex items-center justify-end pr-2 pb-2">
                <button
                  type="submit"
                  className="flex h-11 items-center gap-2 rounded-xl bg-white/90 px-6 text-sm font-medium text-black transition-all duration-300 hover:bg-white hover:scale-[1.02] active:scale-[0.98]"
                >
                  Build
